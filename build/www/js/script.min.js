...
function linkify(a) {
    ...
    return a.replace(b, "<a href='$1' target='_blank'>$1</a>")/*.replace(/r\/(\w+)/g, "<a href='https://web.archive.org/web/20220105113941/https://reddit.com/r/$1' target='_blank'>r/$1</a>") removed for breaking reddit links*/
}
...
function loadTest() {
    $("#login_card").hide(), $("#login_error").hide(), $("#login_load").show(), window.loadTestInterval = rInterval(function() {
        try {
...
function setup() {
    $("#chat_send").click(sendInput), $("#chat_message").keypress(function(a) {
        ...
        /*document.getElementById("content").style.backgroundColor=a.background*/ }), socket.on("updateAll", function(a) {
...
BonziData.event_list_joke = [{
    ...
    window.BonziHandler = new function() {
        return this.framerate = 1 / 15, this.spriteSheets = {}, this.prepSprites = function() {
            for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "cyan", "orange"], b = 0; b < a.length; b++) {
                var c = a[b],
                    d = {
        ...
        }.bind(this), 1e3 / 60), $(window).resize(this.resize.bind(this)), this.bonzisCheck = function() {
            for (var a = 0; a < usersAmt; a++) {
                var b = usersKeys[a];
                if (b in bonzis) {
                    var c = bonzis[b];
...
var loadQueue = new createjs.LoadQueue,
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziOrange", "bonziCyan", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "topjej"];
$(window).load(function() {
    $("#login_card").show(), $("#login_load").hide(), loadBonzis()
});
var undefined, hostname = isApp ? "bonziworld.com" : window.location.hostname,
...
$(function() {
    $("#login_go").click(function() {
        login()
    }), $("#login_room").val(window.location.hash.slice(1)), $("#login_name, #login_room").keypress(function(a) {
        13 == a.which && login()
        ...
        $("#login_card").show(), $("#login_load").hide(), $("#login_error").show().text("Error: " + b[a.reason] + " (" + a.reason + ")")
